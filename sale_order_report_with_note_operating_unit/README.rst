...
==========================================
Sale Order Report With Note Operating Unit
==========================================

This module introduces the following features:

* The particularity of this module is that it replaces the header of the company with that of the Operating Unit (OU) in Sale Order Report.
